...
export default function HRDashboard() {
  ...
  // Calculate initial active menu based on current path
  const getInitialActiveMenu = () => {
    const path = window.location.pathname;
    const menuItem = menuItems.find((item) => path.includes(item.path));
    return menuItem ? menuItem.name.toLowerCase() : "dashboard";
  };
    ...
    <>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-2 sm:gap-3">
              ...
              <button
                ...
                className="p-2 hover:bg-blue-600 rounded-full text-white bg-blue-500 w-8 h-8 flex items-center justify-center text-sm transition"
              >
                V
              </button>
            </div>
      ...
      {settingsOpen && (
        <>
          ...
          <div className="fixed top-16 right-20 sm:right-24 z-50 w-64 bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
            ...
            >
              ...
              <span className="text-gray-800">All Settings</span>
            </button>
          </div>
        </>
      )}
      ...
      {notificationsOpen && (
        <>
          ...
          <div className="fixed top-16 right-12 sm:right-16 z-50 w-80 bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
            ...
            <div className="max-h-96 overflow-y-auto">
              <button
                onClick={() => setNotificationsOpen(false)}
                className="w-full px-4 py-3 hover:bg-gray-50 transition text-left border-b border-gray-100"
              >
                <div className="flex gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      Sarah added Q4 report to Documents
                    </p>
              ...
              >
                <div className="flex gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      Please review the updated company policies
                    </p>
              ...
              >
                <div className="flex gap-3">
                  <div className="w-2 h-2 bg-transparent rounded-full mt-2 flex-shrink-0"></div>
                  <div className="flex-1">
                    <p className="text-sm text-gray-600">Welcome to PMS!</p>
                    <p className="text-xs text-gray-500 mt-1">
      ...
      {profileModalOpen && (
        <>
          ...
          <div className="fixed top-16 right-4 sm:right-8 z-50 w-64 bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
            <button
